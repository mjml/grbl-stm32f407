...
// Define FLASH memory address location values for Grbl settings and parameters
// Note: The STM32F407xx has 512kB or 1MB of FLASH memory. The STM32F407ZETG has 512kB of memory located at 0x08000000-0x080FFFFF
#define FLASH_ADDR                   (flash_data_ptr)
#define FLASH_ADDR_GLOBAL            (flash_data_ptr+1)      // flash+1
#define FLASH_ADDR_PARAMETERS        (flash_data_ptr+0x200)  // flash+512
#define FLASH_ADDR_STARTUP_BLOCK     (flash_data_ptr+0x1000) // flash+4096
#define FLASH_ADDR_BUILD_INFO        (flash_data_ptr+0x2000) // flash+8192

// Define EEPROM address indexing for coordinate parameters
//#define N_COORDINATE_SYSTEM 6  // Number of supported work coordinate systems (from index 1)
#define N_COORDINATE_SYSTEM 5  // MJ- This seemed to be a typo, 0:G54 1:G55 2:G56 3:G57 4:G58 5:G59 so 5 starting at index 1
#define SETTING_INDEX_NCOORD N_COORDINATE_SYSTEM+1 // Total number of system stored (from index 0)
// NOTE: Work coordinate indices are (0=G54, 1=G55, ... , 5=G59)
